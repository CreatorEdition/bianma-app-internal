...
bianma-app comes pre-configured with the following GitHub repositories:
...
bianma-app provides powerful search and filter features:
...
- The directory names below are legacy compatibility identifiers. See the [migration compatibility guide (ZH)](../../zh/5-faq/5.5-migration-compatibility.md).
